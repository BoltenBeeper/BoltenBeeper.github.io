const letters = {
    reviews: [
        { type: "text", content: "Riley is an amazing partner and someone that I love to work with. With impeccable style, he maintains a positive, flexible, and humble attitude while excelling at every task given to him. It took him no time at all to grow from curbside into other departments, including Connections. Always happy and willing to help out where needed, Riley embodies everything we love in a partner who cares about people, the community, and the business. I can see him going far and becoming a leader in the future, but for now, he is easily one of my favorite people to see when I come into HEB.<br><br> - Steven Boutwell, HEB Connections Manager", label: "Spirit of HEB Award Nomination" },
        { type: "text", content: "Riley deserves the Customer Service Award because all his interactions with customers and partners are positive and with a smile. I have witnessed him work in many departments and always has the same energy and genuine kind approach. Riley helped Blooms during Valentines, and was not afraid to step up to complete any task from interaction with customers, educating them on our coupons and deals, to bringing product to replenish the floor. Riley has heart for helping others and I'm happy he is part of A2 store team!<br><br> - Beatrice Guia, HEB Blooms Manager", label: "Customer Service Award Nomination" },
        { type: "text", content: "At any store event, curbside curbie, Riley does an incredible job taking care of our Austin 2 customers. He has a great way through servant leadership in helping customers through the app, salesfloor finding items. He has an omnichannel mindset when it comes to service. Thank you for always helping out customers!<br><br> - Karina Gonna, HEB eStore Manager", label: "Customer Service Award Nomination" },
