...
To add a new project to the My Work page:
 ...
 1. Copy and paste one of the folders from the "details" folder. The copied folder should contain a .html, .css, and .js, file. (Any of the folders will do but it's best to start with whichever one best matches the styles of the page you want to make.)
